...
public class GitWrapper {
    ...
    public String commit(String author, String message) throws IOException {
        CommitFile commit = new CommitFile(author, message, git);
        commit.commitFile();
        git.gitGIT().updateCommitHistory(commit);
        return git.getHEAD().getContents();
    };
